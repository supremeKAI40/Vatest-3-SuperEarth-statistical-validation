...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 11 12:25:36 2023
...
Rs = 0.732189 * R_sun     #Radius of star
Mp = 0.01236322006598534508 * M_jup     #Mass of planet
Rp = 0.1511505816322183671 * R_jup      #Radius of planet
T =677.987026739462            #Temperature of isothermal part of the atmosphere
...
pickleFile = open("ETC-calculation-TOI871b-HST-G141-10chanels.p","rb")
obj = pd.read_pickle(pickleFile)
wave=obj['planet_spec']['binwave']
spec=obj['planet_spec']['binspec']
error=obj['planet_spec']['error']
...
pickleFile = open("ETC-calculation-TOI871b-JWST-Slitless-MIRI-1pixel.p","rb")
...
#JWST NIRSpec G140H f070lp SUB 2048 TOI-871b 1 pixel
pickleFile = open("ETC-calculation-TOI871b-JWST-G140H-f070lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G140H f100lp SUB 2048 TOI-871b 1 pixel
pickleFile = open("ETC-calculation-TOI871b-JWST-G140H-f100lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G235H f170lp SUB 2048 TOI-871b 1 pixel
pickleFile1 = open("ETC-calculation-TOI871b-JWST-G235H-f170lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G395H f290lp SUB 2048 TOI-871b 1 pixel
pickleFile1 = open("ETC-calculation-TOI871b-JWST-G395H-f290lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRCam F322W2 TOI-871b 1 pixel
pickleFile1 = open("ETC-calculation-TOI871b-JWST-F322W2-SUB258-NIRCam-1pixel.p","rb")
...
#JWST NIRCam F444W TOI-871b 1 pixel
pickleFile1 = open("ETC-calculation-TOI871b-JWST-F444W-SUB258-NIRCam-1pixel.p","rb")
...
#JWST NIRISS Sub256 TOI-871b 1 pixel
pickleFile1 = open("ETC-calculation-TOI871b-JWST-Sub256-NIRISS-1pixel.p","rb")
...
plt.plot(1e6*wavelengths, 1.07*transit_depths, color="green", label="logZ=0.1, C/O=0.2")
