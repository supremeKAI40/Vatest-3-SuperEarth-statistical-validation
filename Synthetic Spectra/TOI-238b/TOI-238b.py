...
abundances = getter.get(2.05, 0.25)
...
Rs = 0.766028 * R_sun     #Radius of star
Mp = 0.01189558933978960426 * M_jup     #Mass of planet
Rp = 0.1468510109995082302 * R_jup      #Radius of planet
T = 1434.56225499486            #Temperature of isothermal part of the atmosphere
...
plt.plot(1e6*wavelengths, transit_depths, color="cyan", label="logZ=2.05, C/O=0.18")
