...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 10 22:32:39 2023
...
Rs = 0.542573 * R_sun     #Radius of star
Mp = 0.01400415537748468837 * M_jup     #Mass of planet
Rp = 0.1647514259024042971 * R_jup      #Radius of planet
T = 511.990531324541            #Temperature of isothermal part of the atmosphere
...
pickleFile = open("ETC-calculation-TOI2068b-HST-G102-10chanels.p","rb")
...
pickleFile = open("ETC-calculation-TOI2068b-HST-G141-10chanels.p","rb")
obj = pd.read_pickle(pickleFile)
wave=obj['planet_spec']['binwave']
spec=obj['planet_spec']['binspec']
error=obj['planet_spec']['error']
...
pickleFile = open("ETC-calculation-TOI2068b-JWST-Slitless-MIRI-1pixel.p","rb")
...
#JWST NIRSpec G140H f070lp SUB 2048 TOI-2068b 1 pixel
pickleFile = open("ETC-calculation-TOI2068b-JWST-G140H-f070lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G140H f100lp SUB 2048 TOI-2068b 1 pixel
pickleFile = open("ETC-calculation-TOI2068b-JWST-G140H-f100lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G235H f170lp SUB 2048 TOI-2068b 1 pixel
pickleFile1 = open("ETC-calculation-TOI2068b-JWST-G235H-f170lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G395H f290lp SUB 2048 TOI-2068b 1 pixel
pickleFile1 = open("ETC-calculation-TOI2068b-JWST-G395H-f290lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRCam F322W2 TOI-2068b 1 pixel
pickleFile1 = open("ETC-calculation-TOI2068b-JWST-F322W2-SUB258-NIRCam-1pixel.p","rb")
...
#JWST NIRCam F444W TOI-2068b 1 pixel
pickleFile1 = open("ETC-calculation-TOI2068b-JWST-F444W-SUB258-NIRCam-1pixel.p","rb")
...
#JWST NIRISS Sub256 TOI-2068b 1 pixel
pickleFile1 = open("ETC-calculation-TOI2068b-JWST-Sub256-NIRISS-1pixel.p","rb")
