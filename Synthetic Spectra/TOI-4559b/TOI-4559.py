...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug 12 03:02:20 2023
...
Rs = 0.426767 * R_sun     #Radius of star
Mp = 0.01136074030714019981 * M_jup     #Mass of planet
Rp = 0.1440048116426732028 * R_jup      #Radius of planet
T = 553.6865153972            #Temperature of isothermal part of the atmosphere
...
pickleFile = open("ETC-calculation-TOI4559b-HST-G102-10chanels.p","rb")
...
pickleFile = open("ETC-calculation-TOI4559b-HST-G141-10chanels.p","rb")
obj = pd.read_pickle(pickleFile)
wave=obj['planet_spec']['binwave']
spec=obj['planet_spec']['binspec']
error=obj['planet_spec']['error']
...
pickleFile = open("ETC-calculation-TOI4559b-JWST-Slitless-MIRI-1pixel.p","rb")
...
#JWST NIRSpec G140H f070lp SUB 2048 TOI-4559b 1 pixel
pickleFile = open("ETC-calculation-TOI4559b-JWST-G140H-f070lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G140H f100lp SUB 2048 TOI-4559b 1 pixel
pickleFile = open("ETC-calculation-TOI4559b-JWST-G140H-f100lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G235H f170lp SUB 2048 TOI-4559b 1 pixel
pickleFile1 = open("ETC-calculation-TOI4559b-JWST-G235H-f170lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G395H f290lp SUB 2048 TOI-4559b 1 pixel
pickleFile1 = open("ETC-calculation-TOI4559b-JWST-G395H-f290lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRCam F322W2 TOI-4559b 1 pixel
pickleFile1 = open("ETC-calculation-TOI4559b-JWST-F322W2-SUB258-NIRCam-1pixel.p","rb")
...
#JWST NIRCam F444W TOI-4559b 1 pixel
pickleFile1 = open("ETC-calculation-TOI4559b-JWST-F444W-SUB258-NIRCam-1pixel.p","rb")
...
#JWST NIRISS Sub256 TOI-4559b 1 pixel
pickleFile1 = open("ETC-calculation-TOI4559b-JWST-Sub256-NIRISS-1pixel.p","rb")
...
plt.plot(1e6*wavelengths, transit_depths, color="yellow", label="logZ=0.7")
