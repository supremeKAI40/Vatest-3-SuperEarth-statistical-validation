...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 10 22:48:39 2023
...
abundances = getter.get(2.0, 0.53)
...
Rs = 0.490737 * R_sun     #Radius of star
Mp = 0.01489668849382009067 * M_jup     #Mass of planet
Rp = 0.1720396443052146229 * R_jup      #Radius of planet
T = 532.471100867982            #Temperature of isothermal part of the atmosphere
...
pickleFile = open("ETC-calculation-TOI1467b-HST-G102-10chanels.p","rb")
...
pickleFile = open("ETC-calculation-TOI1467b-HST-G141-10chanels.p","rb")
obj = pd.read_pickle(pickleFile)
wave=obj['planet_spec']['binwave']
spec=obj['planet_spec']['binspec']
error=obj['planet_spec']['error']
...
pickleFile = open("ETC-calculation-TOI1467b-JWST-Slitless-MIRI-1pixel.p","rb")
...
#JWST NIRSpec G140H f070lp SUB 2048 TOI-1467b 1 pixel
pickleFile = open("ETC-calculation-TOI1467b-JWST-G140H-f070lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G140H f100lp SUB 2048 TOI-1467b 1 pixel
pickleFile = open("ETC-calculation-TOI1467b-JWST-G140H-f100lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G235H f170lp SUB 2048 TOI-1467b 1 pixel
pickleFile1 = open("ETC-calculation-TOI1467b-JWST-G235H-f170lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G395H f290lp SUB 2048 TOI-1467b 1 pixel
pickleFile1 = open("ETC-calculation-TOI1467b-JWST-G395H-f290lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRCam F322W2 TOI-1467b 1 pixel
pickleFile1 = open("ETC-calculation-TOI1467b-JWST-F322W2-SUB258-NIRCam-1pixel.p","rb")
...
#JWST NIRCam F444W TOI-1467b 1 pixel
pickleFile1 = open("ETC-calculation-TOI1467b-JWST-F444W-SUB258-NIRCam-1pixel.p","rb")
...
#JWST NIRISS Sub256 TOI-1467b 1 pixel
pickleFile1 = open("ETC-calculation-TOI1467b-JWST-Sub256-NIRISS-1pixel.p","rb")
...
plt.plot(1e6*wavelengths, transit_depths, color="pink", label="logZ=1.0")
