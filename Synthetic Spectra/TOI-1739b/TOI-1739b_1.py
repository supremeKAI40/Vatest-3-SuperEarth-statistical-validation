...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 10 22:49:11 2023
...
abundances = getter.get(0.2, 0.53)
...
Rs = 0.780707 * R_sun     #Radius of star
Mp = 0.0131339596559554711 * M_jup     #Mass of planet
Rp = 0.1572366055890069558 * R_jup      #Radius of planet
T = 597.489954033989            #Temperature of isothermal part of the atmosphere
...
pickleFile = open("ETC-calculation-TOI1739b-HST-G102-10chanels.p","rb")
...
pickleFile = open("ETC-calculation-TOI1739b-HST-G141-10chanels.p","rb")
obj = pd.read_pickle(pickleFile)
wave=obj['planet_spec']['binwave']
spec=obj['planet_spec']['binspec']
error=obj['planet_spec']['error']
...
pickleFile = open("ETC-calculation-TOI1739b-JWST-Slitless-MIRI-1pixel.p","rb")
...
#JWST NIRSpec G140H f070lp SUB 2048 TOI-1739b 1 pixel
pickleFile = open("ETC-calculation-TOI1739b-JWST-G140H-f070lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G140H f100lp SUB 2048 TOI-1739b 1 pixel
pickleFile = open("ETC-calculation-TOI1739b-JWST-G140H-f100lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G235H f170lp SUB 2048 TOI-1739b 1 pixel
pickleFile1 = open("ETC-calculation-TOI1739b-JWST-G235H-f170lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRSpec G395H f290lp SUB 2048 TOI-1739b 1 pixel
pickleFile1 = open("ETC-calculation-TOI1739b-JWST-G395H-f290lp-NIRSpec-1pixel.p","rb")
...
#JWST NIRCam F322W2 TOI-1739b 1 pixel
pickleFile1 = open("ETC-calculation-TOI1739b-JWST-F322W2-SUB128-NIRCam-1pixel.p","rb")
...
#JWST NIRCam F444W TOI-1739b 1 pixel
pickleFile1 = open("ETC-calculation-TOI1739b-JWST-F444W-NIRCam-1pixel.p","rb")
...
#JWST NIRISS Sub256 TOI-1739b 1 pixel
pickleFile1 = open("ETC-calculation-TOI1739b-JWST-Sub256-NIRISS-1pixel.p","rb")
...
plt.plot(1e6*wavelengths, transit_depths, color="black", label="logZ=0.2")
